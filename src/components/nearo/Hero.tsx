...
const HeroVariant1 = () => (
    ...
    >
        <h1 className="text-[clamp(2.5rem,5vw,4.5rem)] font-medium text-white mb-6 max-w-5xl leading-[1.2]" style={{ letterSpacing: '-0.06em' }}>
            Clarity. Accountability.<br />Scalable Execution.
        </h1>
        ...
        <div className="flex items-center gap-4 mb-20">
            ...
            <a href="https://demo-emp.sohub.com.bd/" target="_blank" rel="noopener noreferrer" className="bg-white/20 backdrop-blur-sm text-white border border-white/40 px-8 py-4 rounded-full text-sm font-medium tracking-normal hover:bg-white/30 transition-colors whitespace-nowrap">
                See How EMP Works
            </a>
        </div>
...
const HeroVariantMobile = () => (
    <motion.div
        ...
        style={{ fontFamily: '"Inter", sans-serif' }}
    >
        <h1 className="text-[2.1rem] font-medium text-white mb-4 leading-[1.2] px-2" style={{ letterSpacing: '-0.06em' }}>
            Clarity. Accountability.<br />Scalable Execution.
        </h1>
        ...
        <div className="flex flex-col items-center gap-3 mb-24 w-full px-4">
            ...
            <a href="https://demo-emp.sohub.com.bd/" target="_blank" rel="noopener noreferrer" className="bg-white/20 backdrop-blur-sm text-white border border-white/40 px-6 py-3 rounded-full text-xs font-medium tracking-normal hover:bg-white/30 transition-colors whitespace-nowrap w-full text-center">
                See How EMP Works
            </a>
        </div>
