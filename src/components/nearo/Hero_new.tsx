...
export const Hero = () => {
    ...
    return (
        <section className="relative min-h-[90vh] pt-[37px] px-[37px] pb-20 overflow-visible">
            {/* Background Card with Rounded Corners and Gradient */}
            <div
                className="absolute top-[37px] left-[37px] right-[37px] bottom-0 pointer-events-none rounded-3xl overflow-hidden"
                style={{
                    background: '#50a7e3'
                }}
            >
...
const HeroVariant1 = () => (
    ...
    >
        ...
        <motion.div
            ...
            className="w-full max-w-4xl mx-auto relative h-[500px] overflow-visible"
        >
            {/* Floating Wireframe Card - Left */}
            <div className="absolute left-0 top-32 bg-white rounded-2xl p-5 shadow-2xl w-72 z-20 border border-gray-100">
            ...
            <div className="absolute right-0 top-20 bg-white rounded-2xl p-5 shadow-2xl w-80 z-20 border border-gray-100">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-0 w-[380px] overflow-hidden h-[500px]">
