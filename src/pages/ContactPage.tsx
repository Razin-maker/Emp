            ...
            <header className="py-6 px-6 border-b border-gray-200">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <Link to="/" className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-[#50a7e3] rounded-lg flex items-center justify-center text-white font-bold">
                            😊
                        </div>
                        <span className="text-xl font-bold tracking-tight text-slate-900">EMP</span>
                    </Link>
                    <Link to="/" className="flex items-center gap-2 text-gray-600 hover:text-slate-900 transition-colors">
            ...
            <section className="py-20 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="bg-gray-50 rounded-3xl p-8 md:p-12">
